          ...
          .then(data => {
             for(dentist of data){
                ...
                dentistRow.innerHTML =
                    '<td class=\"td_delete\">' +
                        '<button class="btn btnDeleteOdontologo mr-2 btn-outline-danger"  id="deleteOdontologo' + dentist.id + '">' +
                        ...
                        '</button>' +
                        '<button class="btn btn-outline-warning btnEditOdontologo" data-bs-toggle="modalEditOdontologoId" data-bs-target="#modalEditOdontologoId" id="editOdontologo' + dentist.id + '">' +
